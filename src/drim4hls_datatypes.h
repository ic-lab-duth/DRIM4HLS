...
struct dmem_in_t {
    ...
    ac_int < BLOCK_WIDTH, false > data_in;
    bool read_en;
    bool write_en;

    static
    const int width = BLOCK_WIDTH + 2*XLEN + 2;
    //
    // Default constructor.
    //
    dmem_in_t() {
...
struct dmem_out_t {
    ...
    // Member declarations.
    //
    ac_int < BLOCK_WIDTH, false > data_out;

    static const int width = BLOCK_WIDTH;
    //
    // Default constructor.
    //
    dmem_out_t() {
...
struct dcache_out_t {
    ...
    static const int width = BLOCK_WIDTH + 1;
    //
    // Default constructor.
    //
    dcache_out_t() {
