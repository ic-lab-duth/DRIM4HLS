...
struct imem_out_t {
    ...
    // Member declarations.
    //
    sc_uint < ICACHE_LINE > instr_data;
...
struct dmem_in_t {
    ...
    sc_uint < XLEN > write_addr;
    sc_uint < DCACHE_LINE > data_in;
    bool read_en;
    bool write_en;
...
struct btb_data_t {
    ...
    // Member declarations.
    //
    sc_uint < BTB_TAG_WIDTH > tag;
    sc_uint < PC_LEN > bta;
    sc_uint < BTB_PREDICTION_BITS_WIDTH > prediction_data;
